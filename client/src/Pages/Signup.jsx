    ...
    <div className="signup-container">
      <div className="signup-card">
        ...
        <form className="signup-form" onSubmit={handleSubmit}>
          ...
          {accountCreated && <p style={{ textAlign: 'center', color: '#065f46', fontSize: '14px', marginTop: '10px' }}>Redirecting to login...</p>}
          ...
          <button className="signup-btn" type="submit" disabled={loading || accountCreated}>{accountCreated ? 'Account Created! ✓' : loading ? 'Creating...' : 'Create account'}</button>
        </form>
